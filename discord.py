...
if __name__ == "__main__":
    ...
    if schedule_unit == 's':
        schedule.every(schedule_number).seconds.do(send_merged_to_discord, args.url, args.authorization)
    elif schedule_unit == 'm':
        schedule.every(schedule_number).minutes.do(send_merged_to_discord, args.url, args.authorization)
    elif schedule_unit == 'h':
        schedule.every(schedule_number).hours.do(send_merged_to_discord, args.url, args.authorization)
    else:
